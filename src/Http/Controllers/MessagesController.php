...
class MessagesController extends Controller
{
     ...
     */
    public function index($id = null): Application|Factory|View
    {
        /** @var User $user */
        $user = Auth::user();
    ...
    public function idFetchData(Request $request): JsonResponse
    {
        ...
        if ($fetch) {
            /** @var User $user */
            $user = Chatify::getUserWithAvatar($fetch);
    ...
    public function fetch(Request $request): JsonResponse
    {
        ...
        if ($totalMessages < 1) {
            ...
            // this is where i would check following status and return other messages
